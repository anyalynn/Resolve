    ...
    public class CasesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var @case = await _context.Case
                ...
                .Include(p => p.PatientEvent)
                .Include(p => p.Travel)
                .Include(p => p.AxiumFeeSchedule)
                .Include(p => p.CompBasePayChange)
                .Include(p => p.CompAllowanceChange)
                .Include(p => p.CostAllocationChange)
                .Include(p => p.EndDateChange)
                .Include(p => p.FTEChange)
